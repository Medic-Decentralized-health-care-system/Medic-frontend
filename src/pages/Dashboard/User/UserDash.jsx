    ...
    <>
      <div className={styles.container}>
        ...
        {!editProfile ? (
          ...
          <div className={styles.main_EditProfile}>
            <div className={styles.mainHeader_EditProfile}><h1>Rahul</h1></div>
            <div className={styles.mainBody_EditProfile}>
              <div className={styles.dashTop_EditProfile}>
